function Graph(data, scene) {
    ...
    this.create_random_offsets = function(strength) {
    ...
    this.move_nodes = function( coords_, dim1, dim2, dim3) {
        ...
        for ( var i = 0; i < nodes.vertices.length; ++i) {
            ...
            var x = (coords[i][dim1] + offset.x) * 2000 - 1000;
            var y = (coords[i][dim2] + offset.y) * 2000 - 1000;
            var z;
            if (typeof dim3  == "undefined") {
                if (coords3) {
                    z = coords3[i] * 2000 - 1000;
                } else {
                    z = (coords[0][dim1] + offset.z) * 2000 - 1000;
                }
            } else {
                z = (coords[i][dim3] + offset.z) * 2000 - 1000;
            }
