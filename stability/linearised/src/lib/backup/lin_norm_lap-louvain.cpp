...
CommunityFinder::CommunityFinder(const Graph &gc, const int nb_pass, const double min_modularity, const double time)
  : c(gc,time),nb_pass(nb_pass),min_modularity(min_modularity),time(time)
{}
