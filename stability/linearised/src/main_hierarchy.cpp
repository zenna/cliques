...
// Copyright (C) 2008-2010 V. Blondel, J.-L. Guillaume, R. Lambiotte, E. Lefebvre, Y. William Yu
//
// This program must not be distributed without agreement of the above mentionned authors.
//-----------------------------------------------------------------------------
// Author   : E. Lefebvre, adapted by J.-L. Guillaume, re-adapted by Y. William Yu
// Email    : jean-loup.guillaume@lip6.fr, yun.yu09@imperial.ac.uk
// Location : Paris, France, London, UK
// Time	    : February 2008, March 2010
//-----------------------------------------------------------------------------
...
usage(char *prog_name, char *more) {
  ...
  cerr << "Note, if no input file is provided, will read instead from stdin." << endl;
  exit(0);
}
