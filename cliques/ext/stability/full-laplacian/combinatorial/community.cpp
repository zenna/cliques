...
Community::partition2graph_binary() {
  ...
  g2.degrees  = (unsigned long *)malloc(comm_nodes.size()*4);
  // ligne moidifiee par Antoine : 4 bytes au lieu de 8
  g2.links    = (unsigned int *)malloc((long)g.nb_links*4);
  // ligne moidifiee par Antoine : 4 bytes au lieu de 8
  g2.weights  = (float *)malloc((long)g.nb_links*4);
...
//  cout << g2.nb_links << endl;
  ...
  // ligne moidifiee par Antoine : 4 bytes au lieu de 8
  g2.links = (unsigned int*)realloc(g2.links, (long)g2.nb_links*4);
     g2.weights = (float*)realloc(g2.weights, (long)g2.nb_links*4);
