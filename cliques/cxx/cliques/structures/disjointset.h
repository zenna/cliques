...
class DisjointSetForest
    ...
    public:
        ...
        */
        explicit DisjointSetForest(const boost::unordered_map<int,T>& initialElements)
        :   m_setCount(0)
        {
        ...
        class PartIterator {
        public:
            PartIterator(typename boost::unordered_map<int,Element>::iterator part_itr, DisjointSetForest &parent_disjoint_set)
            ...
            NodeIterator begin() {
                typename boost::unordered_map<int,Element>::iterator tmp_node_itr_ = part_itr_;
                return NodeIterator(tmp_node_itr_ , this->parent_disjoint_set_);
            }

            NodeIterator end() {
                typename boost::unordered_map<int,Element>::iterator tmp_node_itr_ = parent_disjoint_set_.m_elements.end();
                return NodeIterator(tmp_node_itr_ , this->parent_disjoint_set_);
            }
        ...
        PartIterator begin() {
            ...
            typename boost::unordered_map<int,Element>::iterator tmp_part_itr_ = m_elements.begin();
            return PartIterator(tmp_part_itr_, *this);
        }

        PartIterator end() {
            typename boost::unordered_map<int,Element>::iterator tmp_part_itr_ = m_elements.end();
            return PartIterator(tmp_part_itr_ , *this);
        }

        class NodeIterator {
        public:
            NodeIterator(typename boost::unordered_map<int,Element>::iterator node_itr, DisjointSetForest &parent_disjoint_set)
    ...
    private:
        ...
        {
            typename boost::unordered_map<int,Element>::iterator it = m_elements.find(x);
