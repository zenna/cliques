...
void reorder_map(std::map<int, int> &partition_map) {
    ...
    for (std::map<int, int>::iterator itr = temp_partition_map.begin(); itr
        ...
        for (std::map<int, int>::iterator new_itr = temp_partition_map.begin(); new_itr
                != temp_partition_map.end(); ++new_itr) {
...
std::bitset<NBITSET> map_to_bitset(std::map<int, int> &partition_map) {
    ...
    for (std::map<int, int>::iterator itr = partition_map.begin(); itr
            != partition_map.end(); ++itr) {
